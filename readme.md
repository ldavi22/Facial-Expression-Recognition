...
2. **სანიტი ჩეკი (`loss@init` + 4 ნიმუშზე ოვერფიტი) სანდოდ განასხვავებს "პაიფლაინის ბაგს" "მეტი ტრენინგი სჭირდება"-სგან.**
...
5. **"ჯერ ოვერფიტი, შემდეგ რეგულარიზაცია."** გაშვება 6 პლატოს ვერ მიაღწია 80-ე ეპოქაზე -- სიგნალი 4-ე conv ბლოკის დამატებისთვის.
6. **VGG-სტილის double-conv ბლოკები single-conv-ებს მუდმივად ჯობნის.**
7. **ყოველ გაშვებამდე model, optimizer და scheduler ხელახლა ინიციალიზება.**
8. **Skip კავშირები გრადიენტს პირდაპირ გზას აძლევს.** 1x1 conv shortcut კი სხვადასხვა ზომის ბლოკებს შორის არხების განზომილებების შეჯერებას უზრუნველყოფს.
9. **ResNet-სტილის არქიტექტურა VGG4-ზე მეტ რეგულარიზაციას საჭიროებს.** baseline-ზე 31%-იანი train/val სხვაობა მიუთითებს, რომ skip კავშირები მოდელის ტევადობას მნიშვნელოვნად ზრდის.